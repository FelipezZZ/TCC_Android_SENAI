...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(user.getFbnome());
        ...
        FirebaseFirestore.getInstance().collection("/users")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        me = documentSnapshot.toObject(Pessoa.class);
                        fetchMessages();
                    }
                });
            ...
            FirebaseFirestore.getInstance().collection("/conversations")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            ...
                            contact.setUsername(user.getFbnome());
    ...
    private class MessageItem extends Item<ViewHolder> {
        ...
        public void bind(@NonNull ViewHolder viewHolder, int position) {
            ...
            if(message.getFromId().equals(FirebaseAuth.getInstance().getUid())){
                Picasso.get().load(me.getProfileUrl()).into(imgMessage);
            }else{
